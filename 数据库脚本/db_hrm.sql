...
) ENGINE=InnoDB AUTO_INCREMENT=197 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工考勤表';
...
CREATE TABLE `att_leave` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `type_id` int unsigned DEFAULT NULL COMMENT '休假类型id',
  ...
  `is_deleted` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='请假表';
...
CREATE TABLE `att_leave_type` (
  ...
  `name` varchar(20) DEFAULT NULL COMMENT '假期名称',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  `status` tinyint unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='请假类型表';
...
CREATE TABLE `att_overtime` (
  ...
  `type_id` int DEFAULT NULL COMMENT '加班类型',
  `dept_id` int DEFAULT NULL COMMENT '部门id',
  `count_type` tinyint DEFAULT NULL COMMENT '0小时，1天，默认0，计数加班工资的类型',
  `remark` varchar(200) DEFAULT NULL,
  `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '1启用，0禁用，默认1',
  `is_time_off` tinyint unsigned DEFAULT '0' COMMENT '0不补休，1补休，默认0',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='加班表';
...
CREATE TABLE `att_overtime_type` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '0禁用，1启用，默认1',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `lower_limit` decimal(5,2) DEFAULT NULL COMMENT '工资倍数下限',
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='加班类型表';
...
CREATE TABLE `att_staff_leave` (
  ...
  `type_id` int DEFAULT NULL COMMENT '请假类型id',
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工请假表';
...
CREATE TABLE `att_work_time` (
  ...
  `aft_start_time` time DEFAULT NULL COMMENT '下午上班时间',
  `aft_end_time` time DEFAULT NULL COMMENT '下午下班时间',
  `total_work_time` decimal(3,1) DEFAULT NULL COMMENT '员工总工作时长',
  `remark` varchar(200) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='工作时间表';
...
CREATE TABLE `per_menu` (
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
CREATE TABLE `per_role` (
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工角色表';
...
CREATE TABLE `per_role_menu` (
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='角色菜单关系表';
...
CREATE TABLE `per_staff_role` (
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工角色关系表';
...
INSERT INTO `per_staff_role` VALUES ('13', '1', '2', '1', '2023-03-27 21:04:28', null, '0');
...
CREATE TABLE `sal_deduct_type` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(20) DEFAULT NULL,
  `name` varchar(20) DEFAULT NULL COMMENT '扣款名称',
  `status` tinyint DEFAULT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='扣款类型表';
...
CREATE TABLE `sal_salary` (
  ...
  `month` char(6) DEFAULT NULL COMMENT '月份',
  `remark` varchar(200) DEFAULT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工工资表';
...
CREATE TABLE `soc_city` (
  ...
  `is_deleted` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='参保城市表';
...
CREATE TABLE `soc_insurance` (
  ...
  `is_deleted` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工五险一金表';
...
CREATE TABLE `sys_dept` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='部门表';
...
CREATE TABLE `sys_docs` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='文件表';
...
INSERT INTO `sys_docs` VALUES ('3', '00cd59944447d5a20c55.jpg', 'jpg', '群57.jpg', '6fba73f412d6a478c7c8c824536accf2', '92', null, null, '2023-01-19 19:45:17', '2023-01-19 19:45:17', '0');
INSERT INTO `sys_docs` VALUES ('4', '00cd59944447d5a20c55.jpg', 'jpg', '群57.jpg', '6fba73f412d6a478c7c8c824536accf2', '92', null, null, '2023-01-19 20:00:09', '2023-01-19 20:00:09', '0');
...
CREATE TABLE `sys_staff` (
  ...
  `avatar` varchar(50) DEFAULT 'avatar.png' COMMENT '员工头像，设置默认头像',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='员工表';

-- ----------------------------
-- Records of sys_staff
-- ----------------------------
INSERT INTO `sys_staff` VALUES ('1', 'admin', 'jack', '0', 'E10A83EE057F20F8DC3949BA59ABBE56', '00cd59944447d5a20c55.jpg', '2000-12-07', '13990849315', '北京', null, '2', '1', '2022-01-22 19:46:27', '2023-03-27 21:02:30', '0');
INSERT INTO `sys_staff` VALUES ('2', 'staff_2', 'lucy', '0', '202CB7007152D234B962AC59075B964B', 'avatar.png', '1996-12-05', null, null, null, '5', '0', '2022-02-22 19:47:58', '2023-01-19 20:05:22', '0');
INSERT INTO `sys_staff` VALUES ('3', 'staff_3', 'james', '0', '202CB7007152D234B962AC59075B964B', 'avatar.png', '1996-12-05', '15808425010', null, null, '9', '1', '2022-12-22 19:48:47', '2023-01-19 20:06:39', '0');
